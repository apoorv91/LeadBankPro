                        ...
                        <section class="panel">
                            ...
                            <form role="form" id="frmEditLicense">
                                ...
                                <div class="form-group">
                                    ...
                                    <input class="form-control form-control-inline input-medium default-date-picker" id="expirationdate"  size="16" type="text" value="<?php echo date('m/d/Y', $data['expirydate']);?>" />
                                </div>
                                <div class="form-group">
