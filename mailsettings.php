...
<body>
                        ...
                        <section class="panel">
                            ...
                            <div class="panel-body">
                                <form class="form-horizontal tasi-form" id="frmSettings">
                                    ...
                                    <div class="form-group">
                                        <label class="col-sm-2 col-sm-2 control-label">SMTP From Name</label>
                                        <div class="col-sm-10">
                                            <input class="form-control" id="smtpfromname" value="<?php echo $configurations['mail']['smtp_from_name'];?>" type="text" placeholder="SMTP From Name">
                                        </div>
                                    </div>
                                    <div class="form-group">
    ...
    $("#btnUpdate").click(function(e){
        ...
        var smtp_from_name = $("#smtpfromname").val();
