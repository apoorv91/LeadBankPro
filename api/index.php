            ...
            {        
                ...
                switch($data['status'])
                {
                    ...
                    { 
                        ...
                        $json['status'] = 301;
                        $json['message'] = "Your license is expired. Please <a href='http://help.ameristarmedia.com'> click here </a> to contact support!";
                        if($configurations['signresponse'] == 'true')
                        {
                            $SignatureHandler->FormatJsonSignature($json);
                        }
                ...
                if($data['ip_count'] > $uuid_array_count){
                    ...
                    $json['status'] = 401;
                    $json['message'] = 'Maximmum limit of registration exceeded. Please contact Administrator.';
